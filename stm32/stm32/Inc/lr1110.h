...
#define LR1110_GET_VERSION_LENGTH               LR1110_NO_PARAM_LENGTH + 4
#define LR1110_GET_TEMPERATURE_LENGTH           LR1110_NO_PARAM_LENGTH + 2
#define LR1110_GET_CHIPEUI_LENGTH               LR1110_NO_PARAM_LENGTH + 8
#define LR1110_GET_SEMTECH_JOINEUI_LENGTH       LR1110_NO_PARAM_LENGTH + 8
#define LR1110_GET_ERRORS_LENGTH                LR1110_NO_PARAM_LENGTH + 2
#define LR1110_GET_BATTERY_VOLTAGE_LENGTH       LR1110_NO_PARAM_LENGTH + 1
