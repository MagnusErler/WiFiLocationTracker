...
#define LR1110_CMD_LENGTH_SET_SLEEP             LR1110_CMD_LENGTH_NO_PARAM + 5
...
#define LR1110_CMD_SET_SLEEP                    0x011B
...
/*!
 * @brief Set LR1110 Sleep
 *
 * @param [in] context Radio abstraction
 * @param [in] sleep_time_ms Sleep time in ms
 */
