...
#define LR1110_GET_VERSION_LENGTH               LR1110_NO_PARAM_LENGTH + 2
#define LR1110_GET_TEMPERATURE_LENGTH           LR1110_NO_PARAM_LENGTH
#define LR1110_GET_GNSS_VERSION_LENGTH          LR1110_NO_PARAM_LENGTH
#define LR1110_GET_CHIP_EUI_LENGTH              LR1110_NO_PARAM_LENGTH + 6
#define LR1110_GET_BATTERY_VOLTAGE_LENGTH       1
